...
def _get_output_shape(shape, axis):
...
@testing.parameterize(
    ...
    {'shape': (5, 4), 'axis': -1},
    {'shape': (5, 4), 'axis': -2},
    {'shape': (5, 4, 3, 2), 'axis': 0},
    {'shape': (5, 4, 3, 2), 'axis': 1},
    {'shape': (5, 4, 3, 2), 'axis': 2},
    {'shape': (5, 4, 3, 2), 'axis': 3},
    {'shape': (5, 4, 3, 2), 'axis': -1},
    {'shape': (5, 4, 3, 2), 'axis': -2},
    {'shape': (5, 4, 3, 2), 'axis': -3},
    {'shape': (5, 4, 3, 2), 'axis': -4},
)
class TestCReLU(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.y_shape = _get_output_shape(self.shape, self.axis)
        self.gy = numpy.random.uniform(-1, 1,
                                       self.y_shape).astype(numpy.float32)
